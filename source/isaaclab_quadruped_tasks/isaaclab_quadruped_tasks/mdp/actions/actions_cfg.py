...
from isaaclab_quadruped_tasks.mdp import JointActionCfg
...
class QuadrupedCPGActionCfg(QuadrupedIKActionCfg):
    ...
    """The coupling weight used to coordinate the CPG signals. Defaults to 1.0."""
    step_size: float = 0.1
    ...
    """The pitch angle offset of the body in radians. Defaults to 0.0."""
